...
/**
  ...
  * @brief   HAL configuration file for STM32F407ZGT6
  ******************************************************************************
  */
...
#define HAL_ADC_MODULE_ENABLED    /* Hall sensor ADC3 */
#define HAL_I2C_MODULE_ENABLED    /* I2C1 (DS3231 hardware I2C fallback) */
...
#define HAL_UART_MODULE_ENABLED   /* USART1 (screen) + USART2 (voice) */
...
/* ########################## HSE/HSI Values adaptation ##################### */
  ...
  #define HSE_VALUE    8000000U /*!< Value of the External oscillator in Hz (F407ZGT6 core board = 8MHz) */
#endif /* HSE_VALUE */
