...
UPD:    
	...
	POINT_COLOR=RED;       
	Show_Str(30,50,200,16,"mcudev STM32F407开发板",16,0);				    	 
	Show_Str(30,70,200,16,"GBK字库测试程序",16,0);				    	 
	Show_Str(30,90,200,16,"mcudev.taobao.com",16,0);				    	 
	Show_Str(30,110,200,16,"2015年08月15日",16,0);
	...
	Show_Str(30,220,200,24,"对应汉字为:",16,0); 
		...
		{		
			...
			for(j=0x40;j<0xfe;j++)
			{
				...
				LCD_ShowNum(118,190,fontcnt,5,16);//汉字计数显示	 
			 	fontx[1]=j;
				Show_Font(30+132,220,fontx,16,0);	  
